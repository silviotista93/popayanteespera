...
<!-- ============================================================== -->
<section id="wrapper" class="login-register login-sidebar" style="background-image:url(/admin/assets/images/atardecer-1.jpg);">
    <div class="login-box card">
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="{{ route('login') }}" id="loginform" aria-label="{{ __('Login') }}">
                @csrf
                <div class="text-center">
                    <a href="/" class="text-center db"><img src="/admin/assets/images/logo-popayan.png" width="160" alt="Home" /></a>
                ...
                <div class="form-group text-center m-t-20">
                    <div class="col-xs-12">
                        <button class="btn btn-info btn-lg btn-block  btn-rounded" type="submit">Entrar</button>
                    </div>
                </div>
            </form>
