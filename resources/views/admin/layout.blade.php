...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/admin/assets/node_modules/html5-editor/bootstrap-wysihtml5.css" />
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html">
                    <!-- Logo icon --><b>
                        ...
                        <!-- Dark Logo icon -->
                        <!-- Light Logo icon -->
                        <img src="/admin/assets/images/logo-popayan.png" alt="homepage" class="light-logo"
                             style="margin-left: 44px; height: 52px;"/>
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text --><span>
                         <!-- dark Logo text -->
                    ...
                    <li class="nav-item dropdown u-pro">
                        ...
                        <div class="dropdown-menu dropdown-menu-right animated flipInY">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="btn dropdown-item"><i class="fa fa-power-off"></i> Logout
                                </button>
                            </form>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li class="user-pro"><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                            aria-expanded="false"><img src="/admin/assets/images/users/1.jpg"
...
<script src="/admin/assets/node_modules/html5-editor/wysihtml5-0.3.0.js"></script>
<script src="/admin/assets/node_modules/html5-editor/bootstrap-wysihtml5.js"></script>
<!--DATA TABLES -->
<script src="/admin/assets/node_modules/datatables/jquery.dataTables.min.js"></script>
...
<script src="/admin/js/empresario.js"></script>
