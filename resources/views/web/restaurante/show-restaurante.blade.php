...
@section('contenido')
    <main>
        <section class="hero_in restaurants_detail" style="background: url({{$detalleRestaurante->foto_sitio}}) center center no-repeat !important;-webkit-background-size: cover !important;-moz-background-size: cover !important; -o-background-size: cover !important; background-size: cover !important;">
            <div class="wrapper">
                <div class="container">
                    <h1 class="fadeInUp"><span></span>{{$detalleRestaurante->nombre}}</h1>
                </div>
                <span class="magnific-gallery">
					<a href="img/gallery/restaurant_list_1.jpg" class="btn_photos" title="Photo title" data-effect="mfp-zoom-in">Ver fotos</a>
                ...
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div id="review_summary">
                                            <strong>8.5</strong>
                                            <em>Magnífico</em>
                                            <small>Basado en 4 opiniones</small>
                                        </div>
                                    </div>
                                    <div class="col-lg-9">
                                        <div class="row">
                    ...
                    <aside class="col-lg-4" id="sidebar">
                        <div class="box_detail booking">
                            <div class="price">
                                <img src="{{$detalleRestaurante->imagen}}" width="50%" alt="">
                                <div class="score" style="margin-top: 9%;"><span>Calificación<em>350 Opiniones</em></span><strong>7.0</strong></div>
                            </div>

                            <ul class="hotel_facilities">
                                <li class="icon-location inline" style="font-size: 13px"> {{$detalleRestaurante->direccion}}</li>
                                <li class="icon-phone-squared" style="font-size: 13px"> {{$detalleRestaurante->telefono}}</li>
                            </ul>
